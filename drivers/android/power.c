...
static int android_power_debug_mask = 0;
//    ANDROID_POWER_DEBUG_USER_STATE | ANDROID_POWER_DEBUG_EXIT_SUSPEND | ANDROID_POWER_DEBUG_SUSPEND | ANDROID_POWER_DEBUG_USER_WAKE_LOCK | ANDROID_POWER_DEBUG_WAKE_LOCK;
