...
#if defined(CONFIG_MACH_BIGBANG)
#if (CONFIG_BIGBANG_REV < CONFIG_BIGBANG_REV07)
...
#define SENSOR_BRIGHTNESS	(1 << 21)
#define SENSOR_MODE_SET		(1 << 20)
#define SENSOR_USER_READ	(1 << 19)
#define SENSOR_USER_WRITE	(1 << 18)
#define SENSOR_EFFECT		(1 << 17)
#define SENSOR_QSXGA		(1 << 22)
#define SENSOR_XGA			(1 << 16)
#define SENSOR_QXGA			(1 << 15)
#define SENSOR_CIF			(1 << 14)
