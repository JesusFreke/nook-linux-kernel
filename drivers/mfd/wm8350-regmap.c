...
const struct wm8350_reg_access wm8350_reg_io_map[] = {
	...
	{ 0xFFFF, 0x9FFF, 0xFFFF }, /* R226 - Battery Charger Control 1 */
	{ 0xFFFF, 0xFFFF, 0xFFFF }, /* R227 - Battery Charger Control 2 */
	{ 0xFFFF, 0x00E0, 0x0000 }, /* R228 - Battery Charger Control 3 */
