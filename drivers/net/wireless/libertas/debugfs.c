...
void lbs_debugfs_init_one(struct lbs_private *priv, struct net_device *dev)
{
	...
	if (!priv->debugfs_dir)
		...
		printk(KERN_NOTICE "lbs_debugfs_init_one:debugfs_create_dir(%s) succeed\n", dev->name);
	...
	if (!priv->events_dir)
		...
		printk(KERN_NOTICE "lbs_debugfs_init_one:debugfs_create_dir(subscribed_events) succeed\n");
	...
	if (!priv->regs_dir)
		...
		printk(KERN_NOTICE "lbs_debugfs_init_one:debugfs_create_dir(registers) succeed\n");
...
static void lbs_debug_init(struct lbs_private *priv)
{
	...
	priv->debugfs_debug = debugfs_create_file("libertas_mvl", 0644,
						  priv->debugfs_dir, &items[0],
						  &lbs_debug_fops);
	printk(KERN_NOTICE "LBS_DEBUG_INIT: debugfs_create_file(libertas_mvl)\n");
}
#endif
