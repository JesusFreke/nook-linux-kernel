...
#define IRQ_GROUP1_9		S3C64XX_IRQ_VIC1(21)
...
#define IRQ_EINT_GROUP0_BASE	S3C_EINT(0)
#define IRQ_EINT_GROUP1_BASE	(IRQ_EINT_GROUP0_BASE + IRQ_EINT_GROUP0_NR)
