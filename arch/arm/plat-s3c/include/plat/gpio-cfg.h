...
struct s3c_gpio_cfg {
	...
	//Susan for testing -- unsigned (*get_config)(struct s3c_gpio_chip *chip, unsigned offs);
	int (*get_config)(struct s3c_gpio_chip *chip, unsigned offs, unsigned long *config);
...
extern int s3c_gpio_getcfg(unsigned int pin, unsigned int *config);
...
extern int s3c_gpdat_getval(unsigned int pin, unsigned int *val); 
extern int s3c_gpdat_setval(unsigned int pin, unsigned int level);
