...
*/
static inline int s3c_gpio_do_getcfg(struct s3c_gpio_chip *chip,unsigned int off, unsigned int *config)
{
	return (chip->config->get_config)(chip, off, config);
}
 ...
 *	1x = special function
*/
extern int s3c_gpio_getcfg_s3c64xx_2bit(struct s3c_gpio_chip *chip,unsigned int off, unsigned int *cfg);
extern int s3c_gpio_setcfg_s3c24xx(struct s3c_gpio_chip *chip,unsigned int off, unsigned int cfg);
 ...
 * each case.
*/
extern int s3c_gpio_getcfg_s3c64xx_4bit(struct s3c_gpio_chip *chip,unsigned int off, unsigned int *cfg);
