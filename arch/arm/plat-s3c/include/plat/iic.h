...
struct s3c_i2c_client_platdata
{
	unsigned short slave_addr;
	unsigned long tx_data_setup;
	unsigned long start_setup;
	unsigned long stop_setup;
	unsigned long stop_width;
	unsigned char iiccon_clk_config;
	void *client_owner_platdata; //Pointer to platform_data of device which uses I2C interface to communicate.  PMIC or Gas Gauge etc
};
#endif
/**
